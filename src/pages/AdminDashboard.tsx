...
import { mockDoctors } from "../features/appointments/mockData";
  ...
  return (
    <PageContainer>
      ...
      <HeaderSection>
        <div>
          <PageTitle theme={theme}>
            <MedicalInfoIcon sx={{ fontSize: "2rem" }} />
            Admin Dashboard
          </PageTitle>
      ...
      >
        ...
        >
          <AddIcon sx={{ color: theme.colors.accent, fontSize: "1.2rem" }} />
          <Box>
            <Box
              sx={{ fontSize: "0.9rem", color: theme.colors.text.secondary }}
            >
      ...
      <ContentSplit>
        ...
        <ContentCard theme={theme}>
          ...
          >
            <VerifiedIcon sx={{ fontSize: "0.9rem", color: "#38A169" }} />
