        ...
        <ModalOverlay onClick={() => setSelectedRecord(null)}>
          <ReportCard theme={theme} onClick={(e) => e.stopPropagation()}>
            <ReportHeader theme={theme}>
              <div>
                <h2 css={{ margin: 0, fontSize: "1.5rem" }}>Medical Report</h2>
                <p css={{ margin: "0.5rem 0 0 0", opacity: 0.9 }}>
                  ID: {selectedRecord.id.toUpperCase()}
                </p>
              </div>
              <div css={{ textAlign: "right" }}>
                <div css={{ fontWeight: 700 }}>{selectedRecord.date}</div>
                <div css={{ fontSize: "0.9rem", opacity: 0.9 }}>
